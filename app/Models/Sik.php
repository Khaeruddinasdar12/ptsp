...
class Sik extends Model
{
    ...
    protected $fillable = ['perizinan_id', 'gelar_awal', 'nama', 'gelar_akhir', 'tempat_lahir', 'tanggal_lahir', 'nohp','no_str', 'awal_str', 'akhir_str', 'no_rekomendasi', 'rekomendasi_op', 'alamat', 'subizin_id', 'nama_praktek', 'jalan', 'kelurahan', 'ktp', 'foto', 'str', 'ijazah','rekomendasi_org', 'surat_keterangan', 'surat_keluasan', 'berkas_pendukung', 'created_at', 'updated_at'];
