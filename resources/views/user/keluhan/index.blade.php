...
<h3 class="kt-subheader__title">Keluhan</h3>
        ...
        <div class="row align-items-center">
          <div class="col-12 kt-align-right">
            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-tambah-keluhan">
              <i class="fa fa-plus"></i>Buat Keluhan Dan Saran</button>
            </div>
          </div>
              ...
              <table class="table table-striped table-bordered table-hover belum no-footer dtr-inline" role="grid" aria-describedby="table" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><button href="{{route('keluhan.delete', ['id' => $datas->id]) }}" class="btn btn-outline-danger btn-sm" id="hapus" onclick="hapus()" title="hapus keluhan atau saran">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content ">
        <div class="modal-header">
          <h5 class="modal-title"> Buat Keluhan Dan Saran</h5>
  ...
  <script type="text/javascript">
    function hapus() { // mengubah status kepegawaian
      $(document).on('click', '#hapus', function(){
        Swal.fire({
          title: 'Hapus Keluhan Atau Saran ?',
