...
@section('title', 'Perizinan Ditolak')
...
<div class="kt-subheader__breadcrumbs">
  ...
  Tabel Data Perizinan Ditolak </a>
</div>
@endsection
          ...
          <table class="table table-striped table-bordered table-hover belum no-footer dtr-inline" role="grid" aria-describedby="table" width="100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{route('perizinan.ditolak.show', ['no_tiket' => $datas->no_tiket]) }}" class="btn btn-outline-warning btn-sm" title="ubah data perizinan">
