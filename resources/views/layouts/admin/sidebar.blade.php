  ...
  <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
    ...
    <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
      ...
      <li class="kt-menu__item kt-menu__item--submenu {{ (request()->is('admin/manage-keluhan') || request()->is('admin/manage-keluhan/*') ? 'kt-menu__item--active kt-menu__item--open' : '') }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
        ...
        @endif
   <!--      <li class="kt-menu__item kt-menu__item--submenu {{( request()->is('admin/pegawai/*') || request()->is('admin/pegawai/guru') || request()->is('admin/pegawai/karyawan') || request()->is('admin/pegawai/guru/*') || request()->is('admin/pegawai/karyawan/*') ? 'kt-menu__item--active kt-menu__item--open' : '') }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
          <a href="" class="kt-menu__link kt-menu__toggle {{ ( request()->is('/admin/asrama*') ? 'kt-menu__item--active' : '') }}">
            <span class="kt-menu__link-icon">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          </span><span class="kt-menu__link-text">Pegawai </span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
          <div class="kt-menu__submenu ">
            <span class="kt-menu__arrow"></span>
            <ul class="kt-menu__subnav">
              <li class="kt-menu__item kt-menu__item--parent" aria-haspopup="true">
                <span class="kt-menu__link"><span class="kt-menu__link-text">Pegawai</span></span>
              </li>
              <li class="kt-menu__item kt-menu__item--submenu {{ (request()->is('admin/pegawai/karyawan') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Karyawan</span></a>
              </li>
              <li class="kt-menu__item kt-menu__item--submenu {{ (request()->is('admin/pegawai/guru') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Guru</span></a>
              </li>
              <li class="kt-menu__item kt-menu__item--submenu {{ (request()->is('admin/pegawai/create') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Tambah Pegawai</span></a>
              </li>
              <li class="kt-menu__item kt-menu__item--submenu {{ (request()->is('admin/pegawai/non-aktif') ? 'kt-menu__item--active' : '') }}" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                <a href="" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Pegawai Non Aktif</span></a>
              </li>
            </ul>
          </div>
        </li> -->
