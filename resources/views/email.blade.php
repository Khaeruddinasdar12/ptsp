                                ...
                                <tbody>
                                  <tr>
                                    <td> <div class="container">
                                      <p>Kami dari Tim Verifikasi Perizinan PTSP Makassar, melalui email ini kami sampaikan bahwa: </p>
                                      <center><p>Pendaftaran Anda <b class="text-{{$class}}">{{$status}}</b></p>
                                      </center>
                                      <br>
                                      <p>No Tiket : {{$no_tiket}}</p>
                                      <p>Pesan : {{$pesan}}</p>
                                      <p>Ket : {{$keterangan}}</p>
