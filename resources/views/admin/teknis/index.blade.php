    ...
    <div class="kt-portlet kt-portlet--mobile">
      ...
      <div class="row align-items-center">
        <div class="col-12 kt-align-right">
          <form method="get" action="{{route('perizinan.teknis.index')}}">
          ...
          <table class="table table-striped table-bordered table-hover belum no-footer dtr-inline" role="grid" aria-describedby="table" width="100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{route('perizinan.teknis.show', ['no_tiket' => $datas->no_tiket])}}" class="btn btn-outline-primary btn-sm" title="Lihat detail">
                  <i class="fa fa-eye"></i>
                </a></td>
              </tr>
              @endforeach
