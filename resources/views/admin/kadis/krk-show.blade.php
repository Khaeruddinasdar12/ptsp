  ...
  <div class="kt-portlet">
    ...
    <div class="kt-portlet__body">
      <div class="row">
        ...
        <div class="col-md-12">
          <p>Penggunaan : <b>{{$data->krk->penggunaan}}</b></p>
        </div>
        <div class="col-md-12">
      ...
      <div class="table-responsive">
        ...
        <table class="table table-striped table-bordered table-hover belum no-footer dtr-inline" role="grid" aria-describedby="table" width="100%">
          ...
          <tbody>
            ...
            <tr>
              <td>{{$no = $no+1}}</td>
              <td>Kecamatan & Kelurahan Praktek Lokasi</td>
            ...
            <tr>
              ...
              <td><a href="{{ asset('storage/'.$data->krk->kdb) }}" target="_blank">Lihat Berkas</a></td>
            </tr>
            <tr>
              <td>{{$no = $no+1}}</td>
              <td>Koefisien Dasar Bangunan (KDB) </td>
            ...
            <tr>
              <td>{{$no = $no+1}}</td>
              <td>Koefisien Dasar Hijau (KDH)</td>
              <td>{{ $data->krk->kdh }} %</td>
            </tr> 
            <tr>
              <td>{{$no = $no+1}}</td>
              <td>Jumlah Lantai Maksimun</td>
              <td>{{ $data->krk->jml_lantai_max }} Lantai</td>
            </tr>
            <tr>
              <td>{{$no = $no+1}}</td>
              <td>Lebar Jalan</td>
              <td>{{ $data->krk->lebar }} Meter</td>
            </tr>
            <tr>
              <td>{{$no = $no+1}}</td>
              <td>Garis Sempadan Pagar (GSP)  </td>
              <td>{{ $data->krk->gsp }} Meter</td>
            </tr> 
            <tr>
              <td>{{$no = $no+1}}</td>
              <td>Garis Sempadan Bangunan (GSB)  </td>
              <td>{{ $data->krk->gsb }} Meter</td>
            </tr>
            <tr>
              <td>{{$no = $no+1}}</td>
              <td>Klasifikasi Kegiatan  </td>
              <td>{{ $data->krk->klasifikasi }}</td>
            </tr>   
          </tbody>
        </table>
      </div>
